...
export const generateBlockCss = ( params ) => {
	...
	const generalcss = generateCss( {
		...
		selectorData: [
			{
				selector:
					'{{PRAD}}.prad-block-img-swatches img.prad-swatch-item',
				include: [ 'width', 'height', 'radius' ],
			},
			{
				selector:
					'{{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-content-wrapper',
				include: [ '_ovr_bg' ],
			},
			{
				selector:
					'{{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-content, {{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price,{{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price span,{{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price span span,{{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price span span span, {{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price span.woocommerce-Price-amount, {{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price span.woocommerce-Price-amount span.woocommerce-Price-currencySymbol, {{PRAD}}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-price span.woocommerce-Price-amount span.woocommerce-Price-currencySymbol span',
				include: [ '_ovr_color' ],
			},
		],
...
const generateCustomCss = ( params ) => {
	...
	const _borderStyle = globalStyles?.field_comp?.swatches?.settings.border;

	const customCss =
		( Number( _height ) < 36 || Number( _width ) < 36
			? `.prad-block-img-swatches.prad-block-${ settings.blockid } .prad-swatch-mark-image { display: none !important; }`
			: '' ) +
		...
		Number( settings._styles?.radius?.val ) >= 0
			? `
				.prad-block-${
					settings.blockid
				}.prad-block-img-swatches .prad-swatch-container {
				...
				.prad-block-${
					settings.blockid
				}.prad-block-img-swatches .prad-swatch-mark-image {
					right: calc(${
						...
						Number( settings._styles?.radius?.val / 3 ) < 1
							? '0'
							: Math.min(
									Number( settings._styles?.radius?.val / 3 ),
									10
							  )
					}${ _borderStyle?.unit || 'px' });
					top: calc(${
				...
				.prad-block-${
					settings.blockid
				}.prad-block-img-swatches.prad-swatch-layout_overlay .prad-block-content-wrapper {
					border-radius: 0px 0px ${
						Number(
							settings._styles?.radius?.val - _borderStyle?.val
						) < 0
							? '0'
							: Number(
									settings._styles?.radius?.val -
				...
				.prad-block-${
					settings.blockid
				}.prad-block-img-swatches.prad-swatch-layout_overlay input[type=number].prad-quantity-input.prad-block-input {
					width: calc( 100% - ${
