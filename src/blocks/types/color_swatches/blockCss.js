...
export const generateBlockCss = ( params ) => {
	...
	const generalcss = generateCss( {
		...
		selectorData: [
			{
				selector:
					'{{PRAD}}.prad-block-color-switcher .prad-swatch-item',
				include: [ 'width', 'height', 'radius' ],
			},
			{
				selector:
					'{{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-content-wrapper',
				include: [ '_ovr_bg' ],
			},
			{
				selector:
					'{{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-content, {{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price,{{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price span,{{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price span span,{{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price span span span, {{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price span.woocommerce-Price-amount, {{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price span.woocommerce-Price-amount span.woocommerce-Price-currencySymbol, {{PRAD}}.prad-block-color-switcher.prad-swatch-layout_overlay .prad-block-price span.woocommerce-Price-amount span.woocommerce-Price-currencySymbol span',
				include: [ '_ovr_color' ],
			},
		],
...
const generateCustomCss = ( params ) => {
	...
	const _height =
		...
		globalStyles?.field_comp?.color_swatches?.settings.height?.val;
	const _width =
		settings._styles?.width?.val ||
		globalStyles?.field_comp?.color_swatches?.settings.width?.val;
	const _borderStyle =
		globalStyles?.field_comp?.color_swatches?.settings.border;

	const customCss =
		( Number( _height ) < 36 || Number( _width ) < 36
			? `.prad-block-color-switcher.prad-block-${ settings.blockid } .prad-swatch-mark-image { display: none !important; }`
			: '' ) +
		...
		Number( settings._styles?.radius?.val ) >= 0
			? `
						...
						.prad-block-${
							settings.blockid
						}.prad-block-color-switcher.prad-swatch-layout_overlay input[type=number].prad-quantity-input.prad-block-input {
							width: calc( 100% - ${
		...
		Number( settings._styles?.width?.val ) >= 0
			? `.prad-block-${ settings.blockid } .prad-swatch-wrapper {
				...
				.prad-block-${
					settings.blockid
				}.prad-block-color-switcher .prad-swatch-container .prad-block-input, .prad-block-${
					settings.blockid
				}.prad-block-color-switcher input:is([type=url],[type=tel],[type=text],[type=email],[type=number],[type=search],[type=password]).prad-block-input {
			...
			: '' ) +
		`
			.prad-block-${ settings.blockid }.prad-block-color-switcher.prad-swatch-layout_overlay input[type=number].prad-quantity-input.prad-block-input {
