 ...
 */
class FontPickerBlock extends AbstractBlock {
	...
	public function render(): string {
		...
		if ( empty( $options ) || ! self::has_valid_options( $options ) ) {
			return '';
		}
	...
	private function render_select_box(): string {
		...
		$html .= '<div class="prad-select-box-item">' . esc_html__( 'Select an option', 'flyn-product-options' ) . '</div>';
