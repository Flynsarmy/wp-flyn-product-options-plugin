...
namespace Flyn\ProductOptions\Blocks\Renderers;

use Flyn\ProductOptions\Blocks\Factories\BlockFactory;
...
class BlockRenderer {
	...
	public function render_single_block( array $block_data, int $product_id, int $index = 0 ): string {
		...
		$block = BlockFactory::create_block( $type, $block_data, $product_id );
