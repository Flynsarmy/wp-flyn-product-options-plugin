...
class Deactive {
	...
	private $plugin_slug = 'flyn-product-options';
	...
	public function get_deactive_settings() {
		return array(
			...
			array(
				'id'    => 'not-working',
				'input' => false,
				'text'  => __( 'The plugin isn’t working properly.', 'flyn-product-options' ),
			),
			array(
				'id'    => 'limited-features',
				'input' => false,
				'text'  => __( 'Limited features on the free version.', 'flyn-product-options' ),
			),
			array(
				'id'          => 'better-plugin',
				'input'       => true,
				'text'        => __( 'I found a better plugin.', 'flyn-product-options' ),
				'placeholder' => __( 'Please share which plugin.', 'flyn-product-options' ),
			),
			array(
				'id'    => 'temporary-deactivation',
				'input' => false,
				'text'  => __( "It's a temporary deactivation.", 'flyn-product-options' ),
			),
			array(
				'id'          => 'other',
				'input'       => true,
				'text'        => __( 'Other.', 'flyn-product-options' ),
				'placeholder' => __( 'Please share the reason.', 'flyn-product-options' ),
			),
		);
	}
		...
		<div class="prad-modal" id="prad-deactive-modal">
			<div class="prad-modal-wrap">
				...
				<div class="prad-modal-header">
					<h2><?php esc_html_e( 'Quick Feedback', 'flyn-product-options' ); ?></h2>
					<button class="prad-modal-cancel"><span class="dashicons dashicons-no-alt"></span></button>
				</div>

				<div class="prad-modal-body">
					<h3><?php esc_html_e( 'If you have a moment, please let us know why you are deactivating WowAddons:', 'flyn-product-options' ); ?></h3>
				...
				<div class="prad-modal-footer">
					<a class="prad-modal-submit prad-btn prad-btn-primary" href="#"><?php esc_html_e( 'Submit & Deactivate', 'flyn-product-options' ); ?><span class="dashicons dashicons-update rotate"></span></a>
					<a class="prad-modal-deactive" href="#"><?php esc_html_e( 'Skip & Deactivate', 'flyn-product-options' ); ?></a>
				</div>
	...
	public function deactive_container_js() {
		...
		<script type="text/javascript">
			jQuery( document ).ready( function( $ ) {
				...
				$( document ).on( 'click', '#deactivate-flyn-product-options', function(e) {
					e.preventDefault();
					e.stopPropagation();
